...
class ActionSheet extends React.Component {
  ...
  _cancel = () => {
    ...
    // 修改为不设置cancelButtonIndex，点击背景隐藏 ActionSheet（zhangrong）
  ...
  _createButton (title, index) {
    const styles = this.styles
    const { buttonUnderlayColor, cancelButtonIndex, destructiveButtonIndex, tintColor, selectedColor } = this.props
    const fontColor = destructiveButtonIndex === index ? selectedColor : tintColor
